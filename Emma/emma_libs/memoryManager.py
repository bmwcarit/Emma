...
class MemoryManager:
    ...
    class Settings:
        ...
        def __init__(self, projectName, configurationPath, mapfilesPath, outputPath, analyseDebug, createCategories,
                     removeUnmatched, noPrompt, noResolveOverlap, graphics):
    ...
    def __init__(self, projectName, configurationPath, mapfilesPath, outputPath, analyseDebug, createCategories,
        ...
        self.settings = MemoryManager.Settings(projectName, configurationPath, mapfilesPath, outputPath, analyseDebug,
                                               createCategories, removeUnmatched, noPrompt, noResolveOverlap, graphics)
    ...
    def createReports(self, image=False):
        """
        Creates the reports
        :return: None
        """
        ...
        if self.memoryContent is not None:
            ...
            if image:
                startRegion = input("enter the beginning of memory region to plot (in hex) \n")
                endRegion = input("enter the end of memory region to plot (in hex) \n")
                createGraphics(int(startRegion, 16), int(endRegion, 16))
        else:
